...
import model.service.clecService;

public class ConsoleOptions {

    private AdmServiceImpl admServiceImpl = new AdmServiceImpl();
public class clecServiceImpl implements clecService {
    public class clecServiceImpl implements Service {
    private ServiceImpl clecServiceImpl = new clecServiceImpl();
        ...
        do {
            ...
            switch (opc) {
                case 1 -> {
                    ...
                    if (email.contains("@")) {
                        id_usuario = clecServiceImpl.login(email, password);
                        System.out.println("");
                        if (id_usuario != -1) {
                ...
                case 2 -> {
                    ...
                    System.out.print("Senha: ");
                    String password = lerSubOpc.next();
                    clecServiceImpl.signUp(nome, cpf, email, password);
                    System.out.println("");
                    System.out.println("===== SUCESSO =====");
        ...
        do {
            ...
            switch (opc) {
                ...
                case 2 -> {
                    ...
                    int id_cidade = clecServiceImpl.getHoteisByNomeCidade(nome_cidade);
                    if (id_cidade != -1) {
                        ...
                        if (lerOpc.nextInt() == 1) {
                            ...
                            int id_hotel = clecServiceImpl.getQuartosByNomeHotel(nome_hotel);
                            if (id_hotel != -1) {
                                ...
                                if (lerOpc.nextInt() == 1 && id_usuario != -1) {
                                    ...
                                    int id_quarto = clecServiceImpl.verificaStatusQuarto(id_hotel, numero, data_entrada, data_saida);
                                    ...
                                    if (id_quarto != -1 && id_quarto != -2 && id_quarto != -3) {
                                        ...
                                        if (lerSubOpc.nextInt() == 1) {
                                            clecServiceImpl.realizarRegistroAluguel(id_quarto, id_usuario, data_entrada, data_saida);
                                        }
                                    } else if (id_quarto == -1) {
                ...
                case 4 -> {
                    ...
                    System.out.print("Vai para qual cidade? ");
                    String nome_cidade = lerSubOpc.nextLine();
                    clecServiceImpl.getPacotesByNomeCidadeAndDestino(nome_cidade, destino);
                    System.out.println("_________________ FIM PACOTES __________________");
                }
        ...
        do {
            ...
            switch (opc) {
                ...
                case 3 -> {
                   ...
                   clecServiceImpl.getHoteisByNomeCidade(cidadeDestino);
                    System.out.println("_________________ FIM HOTÉIS __________________");
                    System.out.println("");
                    lerSubOpc = new Scanner(System.in);
                    System.out.print("Nome do hotel: ");
                    String nomeHotel = lerSubOpc.nextLine();
                    int id_hotel = clecServiceImpl.getQuartosByNomeHotel(nomeHotel);
                    System.out.println("_________________ FIM QUARTOS __________________");
                    System.out.println("");
                    lerSubOpc = new Scanner(System.in);
                    ...
                    System.out.print("Qual a data de saída? ");
                    String data_saida = lerSubOpc.next();
                    int id_quarto = clecServiceImpl.verificaStatusQuarto(id_hotel, num_quarto, data_entrada, data_saida);
                    System.out.println("_________________________");
                    System.out.println("");
                    if (id_quarto != -1 && id_quarto != -2 && id_quarto != -3) {
                        System.out.println("Status do quarto: disponível!");
                        ...
                        System.out.print("Digite: ");
                        if (lerSubOpc.nextInt() == 1) {
                            int id_registroaluguel = clecServiceImpl.realizarRegistroAluguel(id_quarto, 1, data_entrada, data_saida);
